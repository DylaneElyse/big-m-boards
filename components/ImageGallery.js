    ...
    <div className="flex flex-col gap-4">
      ...
      {images.length > 1 && (
        <div className="mt-3 sm:mt-4">
          ...
          <div className="grid gap-2" style={{ gridTemplateColumns: `repeat(${Math.min(images.length, 6)}, 1fr)` }}>
            {Array.from({ length: images.length }, (_, index) => {
              ...
              return (
                <button
                  ...
                  className={`relative aspect-square w-full rounded-md overflow-hidden border-2 transition-colors touch-target ${
